...
stepLanguage = {
    "release_notes_label": 'You may wish to read the <a href="release-notes">release notes</a>.',
    "page_title": 'page_title= <span size="xx-large">Welcome</span>'
}

stepPrepare = {
    "page_title": '<span size="xx-large">Preparing to install {0}</span>'.format(distro_flavor),
    "prepare_best_results": 'For best results, please ensure that this computer:',
    "prepare_foss_disclaimer": 'Ubuntu uses third-party software to play Flash, MP3 and other media, and to work with \
    some graphics and wi-fi hardware. Some of this software is proprietary. The software is subject to license terms \
    included with its documentation.',
...
stepPartAsk = {
    ...
    "use_device_desc": '<span size="small"><span foreground="darkred">Warning:</span> \
    This will delete any files on the disk.</span>',
    "use_crypto": 'Encrypt the new Ubuntu installation for security',
    "use_crypto_desc": '<span size="small">You will choose a security key in the next step.</span>',
    "use_lvm": 'Use LVM with the new Ubuntu installation',
    "use_lvm_desc": '<span size="small">This will set up Logical Volume Management. It allows taking snapshots and \
    easier partition resizing.</span>',
    "custom_partitioning": 'Something else',
    "custom_partitioning_desc": '<span size="small">You can create or resize partitions yourself, or choose multiple \
    partitions for Ubuntu.</span>'
}
...
stepPartCrypto = {
    ...
    "crypto_description": 'Disk encryption protects your files in case you lose your computer. It requires you to \
    enter a security key each time the computer starts up.',
    "crypto_warning": '<span foreground="darkred">Warning:</span> If you lose this security key, all data will be \
    lost. If you need to, write down your key and keep it in a safe place elsewhere.',
    "crypto_extra_label": 'For more security:',
    "crypto_extra_time": 'The installation may take much longer.',
    "crypto_description_2": 'Any files outside of Ubuntu will not be encrypted.',
...
stepUserInfo = {
    ...
    "hostname_extra_label": 'The name it uses when it talks to other computers.'
}