...
class PageGtk(PageBase):
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        try:
            ...
            self.atk_resize_use_free_title.add_relation(atk.RELATION_LABEL_FOR, self.atk_resize_use_free)
            self.atk_resize_use_free.add_relation(atk.RELATION_LABELLED_BY, self.atk_resize_use_free_title)
            self.atk_use_device = self.use_device.get_accessible()
            self.atk_use_device_title = self.use_device_title.get_accessible()
            self.atk_use_device_title.add_relation(atk.RELATION_LABEL_FOR, self.atk_use_device)
            self.atk_use_device.add_relation(atk.RELATION_LABELLED_BY, self.atk_use_device_title)
            ...
            self.atk_replace_partition_title.add_relation(atk.RELATION_LABEL_FOR, self.atk_replace_partition)
            self.atk_replace_partition.add_relation(atk.RELATION_LABELLED_BY, self.atk_replace_partition_title)
            ...
            self.atk_custom_partitioning_title.add_relation(atk.RELATION_LABEL_FOR, self.atk_custom_partitioning)
            self.atk_custom_partitioning.add_relation(atk.RELATION_LABELLED_BY, self.atk_custom_partitioning_title)
